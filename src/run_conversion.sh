...
#Yoshi play
./Midi2ROM.py -f verilog -i midi/Yoshi_Play.mid -o verilog/ -p parameters/ -b 84 -n 1 -r Yoshi2 -t0
./Midi2ROM.py -f quartus -i midi/Yoshi_Play.mid -o mif/ -p parameters/ -b 84 -n 1 -r Yoshi2 -t0
